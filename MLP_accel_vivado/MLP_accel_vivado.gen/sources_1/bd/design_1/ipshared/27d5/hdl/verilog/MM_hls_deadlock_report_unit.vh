...
// blk sig is {~MM_MM_inst.entry_proc_U0.ABC_c_blk_n data_FIFO}
                        if ((~entry_proc_U0.ABC_c_blk_n)) begin
                            if (~ABC_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'MM_MM.ABC_c_U' written by process 'MM_MM.writeTiles_U0'");
                                $fdisplay(fp, "Dependence_Channel_path MM_MM.ABC_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~ABC_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'MM_MM.ABC_c_U' read by process 'MM_MM.writeTiles_U0'");
                                $fdisplay(fp, "Dependence_Channel_path MM_MM.ABC_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
// for dep channel 'MM_MM.start_for_writeTiles_U0_U' info is :
// blk sig is {{~MM_MM_inst.start_for_writeTiles_U0_U.if_full_n & MM_MM_inst.entry_proc_U0.ap_start & ~MM_MM_inst.entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~MM_MM_inst.start_for_writeTiles_U0_U.if_read} start_FIFO}
                        if ((~start_for_writeTiles_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_writeTiles_U0_U.if_read)) begin
...
// blk sig is {~MM_MM_inst.computeTiles_U0.grp_computeTiles_Pipeline_j_output_loop_fu_284.AB_stream_blk_n data_FIFO}
                        if ((~computeTiles_U0.grp_computeTiles_Pipeline_j_output_loop_fu_284.AB_stream_blk_n)) begin
                            if (~AB_stream_U.if_empty_n) begin
                                ...
                                $display("//      Blocked by full output FIFO 'MM_MM.AB_stream_U' read by process 'MM_MM.writeTiles_U0'");
                                $fdisplay(fp, "Dependence_Channel_path MM_MM.AB_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
...
// blk sig is {~MM_MM_inst.computeTiles_U0.N_c_blk_n data_FIFO}
                        if ((~computeTiles_U0.N_c_blk_n)) begin
                            if (~N_c_U.if_empty_n) begin
                                ...
                                $display("//      Blocked by full output FIFO 'MM_MM.N_c_U' read by process 'MM_MM.writeTiles_U0'");
                                $fdisplay(fp, "Dependence_Channel_path MM_MM.N_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
...
// blk sig is {~MM_MM_inst.computeTiles_U0.P_c_blk_n data_FIFO}
                        if ((~computeTiles_U0.P_c_blk_n)) begin
                            if (~P_c_U.if_empty_n) begin
                                ...
                                $display("//      Blocked by full output FIFO 'MM_MM.P_c_U' read by process 'MM_MM.writeTiles_U0'");
                                $fdisplay(fp, "Dependence_Channel_path MM_MM.P_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
...
// blk sig is {~MM_MM_inst.writeTiles_U0.P_blk_n data_FIFO}
                    ...
                    0: begin //  for dep proc 'MM_MM.entry_proc_U0'
// for dep channel 'MM_MM.ABC_c_U' info is :
// blk sig is {~MM_MM_inst.writeTiles_U0.ABC_blk_n data_FIFO}
                        if ((~writeTiles_U0.ABC_blk_n)) begin
                            if (~ABC_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'MM_MM.ABC_c_U' written by process 'MM_MM.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path MM_MM.ABC_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~ABC_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'MM_MM.ABC_c_U' read by process 'MM_MM.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path MM_MM.ABC_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
// for dep channel 'MM_MM.start_for_writeTiles_U0_U' info is :
// blk sig is {{~MM_MM_inst.start_for_writeTiles_U0_U.if_empty_n & MM_MM_inst.writeTiles_U0.ap_idle & ~MM_MM_inst.start_for_writeTiles_U0_U.if_write} start_FIFO}
                        if ((~start_for_writeTiles_U0_U.if_empty_n & writeTiles_U0.ap_idle & ~start_for_writeTiles_U0_U.if_write)) begin
                            $display("//      Blocked by missing 'ap_start' from start propagation FIFO 'MM_MM.start_for_writeTiles_U0_U' written by process 'MM_MM.entry_proc_U0',");
                        end
                    end
                    endcase
                end
