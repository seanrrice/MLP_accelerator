...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    MM_hls_deadlock_detect_unit #(5, 0, 4, 4) MM_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.ABC_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_writeTiles_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_writeTiles_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[1] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_readAtTiles_U0_ap_ready);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_readBTiles_U0_ap_ready);
    ...
    assign proc_0_input_sync_blk[3] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_computeTiles_U0_ap_ready);
    ...
    // Process: readAtTiles_U0
    MM_hls_deadlock_detect_unit #(5, 1, 3, 3) MM_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_input_sync_blk[0] = 1'b0 | (ap_sync_readAtTiles_U0_ap_ready & readAtTiles_U0.ap_idle & ~ap_sync_computeTiles_U0_ap_ready);
    ...
    assign proc_1_input_sync_blk[1] = 1'b0 | (ap_sync_readAtTiles_U0_ap_ready & readAtTiles_U0.ap_idle & ~ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_1_input_sync_blk[2] = 1'b0 | (ap_sync_readAtTiles_U0_ap_ready & readAtTiles_U0.ap_idle & ~ap_sync_readBTiles_U0_ap_ready);
    ...
    // Process: readBTiles_U0
    MM_hls_deadlock_detect_unit #(5, 2, 3, 3) MM_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_input_sync_blk[0] = 1'b0 | (ap_sync_readBTiles_U0_ap_ready & readBTiles_U0.ap_idle & ~ap_sync_computeTiles_U0_ap_ready);
    ...
    assign proc_2_input_sync_blk[1] = 1'b0 | (ap_sync_readBTiles_U0_ap_ready & readBTiles_U0.ap_idle & ~ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_2_input_sync_blk[2] = 1'b0 | (ap_sync_readBTiles_U0_ap_ready & readBTiles_U0.ap_idle & ~ap_sync_readAtTiles_U0_ap_ready);
    ...
    // Process: computeTiles_U0
    MM_hls_deadlock_detect_unit #(5, 3, 4, 4) MM_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~computeTiles_U0.grp_computeTiles_Pipeline_k_BLOCK_loop_k_loop_i_loop_fu_243.A_stream_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0;
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0 | (ap_sync_computeTiles_U0_ap_ready & computeTiles_U0.ap_idle & ~ap_sync_readAtTiles_U0_ap_ready);
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~computeTiles_U0.grp_computeTiles_Pipeline_k_BLOCK_loop_k_loop_i_loop_fu_243.B_stream_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0;
    assign proc_3_TLF_FIFO_blk[1] = 1'b0;
    assign proc_3_input_sync_blk[1] = 1'b0 | (ap_sync_computeTiles_U0_ap_ready & computeTiles_U0.ap_idle & ~ap_sync_readBTiles_U0_ap_ready);
    assign proc_3_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_3[1] = dl_detect_out ? proc_dep_vld_vec_3_reg[1] : (proc_3_data_FIFO_blk[1] | proc_3_data_PIPO_blk[1] | proc_3_start_FIFO_blk[1] | proc_3_TLF_FIFO_blk[1] | proc_3_input_sync_blk[1] | proc_3_output_sync_blk[1]);
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~computeTiles_U0.grp_computeTiles_Pipeline_j_output_loop_fu_284.AB_stream_blk_n) | (~computeTiles_U0.N_c_blk_n) | (~computeTiles_U0.P_c_blk_n);
    ...
    assign proc_3_input_sync_blk[3] = 1'b0 | (ap_sync_computeTiles_U0_ap_ready & computeTiles_U0.ap_idle & ~ap_sync_entry_proc_U0_ap_ready);
    ...
    // Process: writeTiles_U0
    MM_hls_deadlock_detect_unit #(5, 4, 2, 2) MM_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~writeTiles_U0.ABC_blk_n);
    assign proc_4_data_PIPO_blk[1] = 1'b0;
    assign proc_4_start_FIFO_blk[1] = 1'b0 | (~start_for_writeTiles_U0_U.if_empty_n & writeTiles_U0.ap_idle & ~start_for_writeTiles_U0_U.if_write);
...
`include "MM_hls_deadlock_report_unit.vh"
