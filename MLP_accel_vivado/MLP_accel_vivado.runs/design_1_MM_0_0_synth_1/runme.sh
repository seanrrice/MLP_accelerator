...
HD_PWD='C:/Users/seanr/vitis_projects/Lab3_MLP_optimization/MLP_accel_vivado/MLP_accel_vivado.runs/design_1_MM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_MM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_MM_0_0.tcl
