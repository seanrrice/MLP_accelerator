...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { B_stream_din { O 512 vector } B_stream_full_n { I 1 bit } B_stream_write { O 1 bit } B_stream_num_data_valid { I 6 vector } B_stream_fifo_cap { I 6 vector } } \
} "
}
