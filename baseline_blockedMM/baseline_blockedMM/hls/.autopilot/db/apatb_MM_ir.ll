...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a100352class.hls::vector<int, 16>.35"([100352 x i512]* %3, [100352 x %"class.hls::vector<int, 16>"]* align 64 %2)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a802816class.hls::vector<int, 16>.19"([802816 x %"class.hls::vector<int, 16>"]* align 64 %0, [802816 x i512]* %1)
  ...
  call fastcc void @"onebyonecpy_hls.p0a131072class.hls::vector<int, 16>.49"([131072 x %"class.hls::vector<int, 16>"]* align 64 %6, [131072 x i512]* %7)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a802816class.hls::vector<int, 16>.19"([802816 x %"class.hls::vector<int, 16>"]* align 64 %dst, [802816 x i512]* readonly %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a802816class.hls::vector<int, 16>.22"([802816 x %"class.hls::vector<int, 16>"]* nonnull %dst, [802816 x i512]* nonnull %src, i64 802816)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a802816class.hls::vector<int, 16>.22"([802816 x %"class.hls::vector<int, 16>"]* %dst, [802816 x i512]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a100352class.hls::vector<int, 16>.35"([100352 x i512]* %dst, [100352 x %"class.hls::vector<int, 16>"]* readonly align 64 %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a100352class.hls::vector<int, 16>.38"([100352 x i512]* nonnull %dst, [100352 x %"class.hls::vector<int, 16>"]* nonnull %src, i64 100352)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a100352class.hls::vector<int, 16>.38"([100352 x i512]* %dst, [100352 x %"class.hls::vector<int, 16>"]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a131072class.hls::vector<int, 16>.49"([131072 x %"class.hls::vector<int, 16>"]* align 64 %dst, [131072 x i512]* readonly %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a131072class.hls::vector<int, 16>.52"([131072 x %"class.hls::vector<int, 16>"]* nonnull %dst, [131072 x i512]* nonnull %src, i64 131072)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a131072class.hls::vector<int, 16>.52"([131072 x %"class.hls::vector<int, 16>"]* %dst, [131072 x i512]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
