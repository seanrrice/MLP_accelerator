...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ABC \
    op interface \
    ports { ABC_dout { I 64 vector } ABC_empty_n { I 1 bit } ABC_read { O 1 bit } ABC_num_data_valid { I 3 vector } ABC_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_N \
    op interface \
    ports { N_dout { I 32 vector } N_empty_n { I 1 bit } N_read { O 1 bit } N_num_data_valid { I 3 vector } N_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_P \
    op interface \
    ports { P_dout { I 32 vector } P_empty_n { I 1 bit } P_read { O 1 bit } P_num_data_valid { I 3 vector } P_fifo_cap { I 3 vector } } \
} "
}
