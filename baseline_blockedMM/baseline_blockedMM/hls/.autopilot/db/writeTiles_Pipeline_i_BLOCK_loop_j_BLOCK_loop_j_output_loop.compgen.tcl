...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AB_stream_dout { I 512 vector } AB_stream_empty_n { I 1 bit } AB_stream_read { O 1 bit } AB_stream_num_data_valid { I 6 vector } AB_stream_fifo_cap { I 6 vector } } \
} "
}
