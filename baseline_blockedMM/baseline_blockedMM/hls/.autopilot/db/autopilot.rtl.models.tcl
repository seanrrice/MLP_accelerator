set SynModuleInfo {
  ...
  {SRCNAME MM MODELNAME MM RTLNAME MM IS_TOP 1
    SUBMODULES {
      {MODELNAME MM_fifo_w64_d4_S RTLNAME MM_fifo_w64_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME ABC_c_U}
      ...
      {MODELNAME MM_fifo_w512_d32_A RTLNAME MM_fifo_w512_d32_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME AB_stream_U}
      ...
      {MODELNAME MM_gmem0_m_axi RTLNAME MM_gmem0_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
      {MODELNAME MM_gmem1_m_axi RTLNAME MM_gmem1_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
      {MODELNAME MM_gmem2_m_axi RTLNAME MM_gmem2_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
      {MODELNAME MM_gmem3_m_axi RTLNAME MM_gmem3_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
