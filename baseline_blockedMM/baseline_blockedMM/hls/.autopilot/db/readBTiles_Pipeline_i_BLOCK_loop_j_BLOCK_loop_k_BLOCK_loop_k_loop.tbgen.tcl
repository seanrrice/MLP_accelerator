set moduleName readBTiles_Pipeline_i_BLOCK_loop_j_BLOCK_loop_k_BLOCK_loop_k_loop
set isTopModule 0
...
set cdfgNum 13
set C_modelName {readBTiles_Pipeline_i_BLOCK_loop_j_BLOCK_loop_k_BLOCK_loop_k_loop}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ bound28 int 85 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bound28", "interface" : "wire", "bitwidth" : 85, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"}]}]} , 
...
set portList { 
	...
	{ m_axi_gmem1_0_WDATA sc_out sc_lv 512 signal 6 } 
	{ m_axi_gmem1_0_WSTRB sc_out sc_lv 64 signal 6 } 
	...
	{ m_axi_gmem1_0_RDATA sc_in sc_lv 512 signal 6 } 
	...
	{ B_stream_din sc_out sc_lv 512 signal 7 } 
	{ B_stream_full_n sc_in sc_logic 1 signal 7 } 
	{ B_stream_write sc_out sc_logic 1 signal 7 } 
	{ B_stream_num_data_valid sc_in sc_lv 6 signal 7 } 
	{ B_stream_fifo_cap sc_in sc_lv 6 signal 7 } 
	{ bound28 sc_in sc_lv 85 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bound28", "direction": "in", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "bound28", "role": "default" }} , 
...
set Spec2ImplPortList { 
	bound28 { ap_none {  { bound28 in_data 0 85 } } }
	...
	B_stream { ap_fifo {  { B_stream_din fifo_data_out 1 512 }  { B_stream_full_n fifo_status_empty 0 1 }  { B_stream_write fifo_data_in 1 1 }  { B_stream_num_data_valid fifo_update 0 6 }  { B_stream_fifo_cap fifo_data 0 6 } } }
}
