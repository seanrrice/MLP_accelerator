set moduleName MM_Pipeline_VITIS_LOOP_35_2
set isTopModule 0
...
set cdfgNum 5
set C_modelName {MM_Pipeline_VITIS_LOOP_35_2}
...
set C_modelArgList {
	...
	{ gmem_addr_1_read int 32 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"},{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "C","offset": { "type": "dynamic","port_name": "C","bundle": "control"},"direction": "READONLY"},{"cName": "ABC","offset": { "type": "dynamic","port_name": "ABC","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "P", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln34", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "gmem_addr_1_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ P sc_in sc_lv 31 signal 1 } 
	{ sext_ln34 sc_in sc_lv 62 signal 2 } 
	{ gmem_addr_1_read sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "P", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "P", "role": "default" }} , 
 	{ "name": "sext_ln34", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln34", "role": "default" }} , 
 	{ "name": "gmem_addr_1_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "gmem_addr_1_read", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	P { ap_none {  { P in_data 0 31 } } }
	sext_ln34 { ap_none {  { sext_ln34 in_data 0 62 } } }
	gmem_addr_1_read { ap_none {  { gmem_addr_1_read in_data 0 32 } } }
}
