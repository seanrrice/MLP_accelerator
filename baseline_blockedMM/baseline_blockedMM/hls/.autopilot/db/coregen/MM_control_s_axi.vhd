...
architecture behave of MM_control_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    constant ADDR_ABC_DATA_0 : INTEGER := 16#34#;
    constant ADDR_ABC_DATA_1 : INTEGER := 16#38#;
    constant ADDR_ABC_CTRL   : INTEGER := 16#3c#;
    ...
    constant ADDR_P_DATA_0   : INTEGER := 16#50#;
    constant ADDR_P_CTRL     : INTEGER := 16#54#;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_ABC_DATA_0 =>
                        rdata_data <= RESIZE(int_ABC(31 downto 0), 32);
                    when ADDR_ABC_DATA_1 =>
                        rdata_data <= RESIZE(int_ABC(63 downto 32), 32);
                    when ADDR_N_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_ABC(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_ABC_DATA_0) then
                    int_ABC(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ABC(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_ABC(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_ABC_DATA_1) then
                    int_ABC(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ABC(63 downto 32));
                end if;
            end if;
        end if;
    end process;
