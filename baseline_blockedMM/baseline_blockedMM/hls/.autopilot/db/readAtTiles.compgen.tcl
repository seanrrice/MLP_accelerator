...
set name MM_mul_27ns_31ns_58_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { A_stream_din { O 512 vector } A_stream_full_n { I 1 bit } A_stream_write { O 1 bit } A_stream_num_data_valid { I 6 vector } A_stream_fifo_cap { I 6 vector } } \
} "
}
