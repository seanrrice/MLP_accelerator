...
reg [15:0] trans_in_cnt_0;// for process AESL_inst_MM.entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (AESL_inst_MM.entry_proc_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process AESL_inst_MM.entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (AESL_inst_MM.entry_proc_U0.ap_done == 1'b1 && AESL_inst_MM.entry_proc_U0.ap_continue == 1'b1) begin
    ...
    // Process: AESL_inst_MM.entry_proc_U0
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~AESL_inst_MM.entry_proc_U0.ABC_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~AESL_inst_MM.start_for_writeTiles_U0_U.if_full_n & AESL_inst_MM.entry_proc_U0.ap_start & ~AESL_inst_MM.entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~AESL_inst_MM.start_for_writeTiles_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[1] = 1'b0 | (AESL_inst_MM.ap_sync_entry_proc_U0_ap_ready & AESL_inst_MM.entry_proc_U0.ap_idle & ~AESL_inst_MM.ap_sync_readAtTiles_U0_ap_ready);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (AESL_inst_MM.ap_sync_entry_proc_U0_ap_ready & AESL_inst_MM.entry_proc_U0.ap_idle & ~AESL_inst_MM.ap_sync_readBTiles_U0_ap_ready);
    ...
    assign proc_0_input_sync_blk[3] = 1'b0 | (AESL_inst_MM.ap_sync_entry_proc_U0_ap_ready & AESL_inst_MM.entry_proc_U0.ap_idle & ~AESL_inst_MM.ap_sync_computeTiles_U0_ap_ready);
    ...
    // Process: AESL_inst_MM.readAtTiles_U0
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~AESL_inst_MM.readAtTiles_U0.grp_readAtTiles_Pipeline_i_BLOCK_loop_j_BLOCK_loop_k_BLOCK_loop_k_loop_fu_78.A_stream_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0;
    assign proc_1_TLF_FIFO_blk[0] = 1'b0;
    assign proc_1_input_sync_blk[0] = 1'b0 | (AESL_inst_MM.ap_sync_readAtTiles_U0_ap_ready & AESL_inst_MM.readAtTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_computeTiles_U0_ap_ready);
    ...
    assign proc_1_input_sync_blk[1] = 1'b0 | (AESL_inst_MM.ap_sync_readAtTiles_U0_ap_ready & AESL_inst_MM.readAtTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_1_input_sync_blk[2] = 1'b0 | (AESL_inst_MM.ap_sync_readAtTiles_U0_ap_ready & AESL_inst_MM.readAtTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_readBTiles_U0_ap_ready);
    ...
    // Process: AESL_inst_MM.readBTiles_U0
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~AESL_inst_MM.readBTiles_U0.grp_readBTiles_Pipeline_i_BLOCK_loop_j_BLOCK_loop_k_BLOCK_loop_k_loop_fu_78.B_stream_blk_n);
    assign proc_2_data_PIPO_blk[0] = 1'b0;
    assign proc_2_start_FIFO_blk[0] = 1'b0;
    assign proc_2_TLF_FIFO_blk[0] = 1'b0;
    assign proc_2_input_sync_blk[0] = 1'b0 | (AESL_inst_MM.ap_sync_readBTiles_U0_ap_ready & AESL_inst_MM.readBTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_computeTiles_U0_ap_ready);
    ...
    assign proc_2_input_sync_blk[1] = 1'b0 | (AESL_inst_MM.ap_sync_readBTiles_U0_ap_ready & AESL_inst_MM.readBTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_2_input_sync_blk[2] = 1'b0 | (AESL_inst_MM.ap_sync_readBTiles_U0_ap_ready & AESL_inst_MM.readBTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_readAtTiles_U0_ap_ready);
    ...
    // Process: AESL_inst_MM.computeTiles_U0
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~AESL_inst_MM.computeTiles_U0.grp_computeTiles_Pipeline_k_BLOCK_loop_k_loop_i_loop_fu_243.A_stream_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0;
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0 | (AESL_inst_MM.ap_sync_computeTiles_U0_ap_ready & AESL_inst_MM.computeTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_readAtTiles_U0_ap_ready);
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~AESL_inst_MM.computeTiles_U0.grp_computeTiles_Pipeline_k_BLOCK_loop_k_loop_i_loop_fu_243.B_stream_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0;
    assign proc_3_TLF_FIFO_blk[1] = 1'b0;
    assign proc_3_input_sync_blk[1] = 1'b0 | (AESL_inst_MM.ap_sync_computeTiles_U0_ap_ready & AESL_inst_MM.computeTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_readBTiles_U0_ap_ready);
    assign proc_3_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_3[1] = dl_detect_out ? proc_dep_vld_vec_3_reg[1] : (proc_3_data_FIFO_blk[1] | proc_3_data_PIPO_blk[1] | proc_3_start_FIFO_blk[1] | proc_3_TLF_FIFO_blk[1] | proc_3_input_sync_blk[1] | proc_3_output_sync_blk[1]);
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~AESL_inst_MM.computeTiles_U0.grp_computeTiles_Pipeline_j_output_loop_fu_284.AB_stream_blk_n) | (~AESL_inst_MM.computeTiles_U0.N_c_blk_n) | (~AESL_inst_MM.computeTiles_U0.P_c_blk_n);
    ...
    assign proc_3_input_sync_blk[3] = 1'b0 | (AESL_inst_MM.ap_sync_computeTiles_U0_ap_ready & AESL_inst_MM.computeTiles_U0.ap_idle & ~AESL_inst_MM.ap_sync_entry_proc_U0_ap_ready);
    ...
    // Process: AESL_inst_MM.writeTiles_U0
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~AESL_inst_MM.writeTiles_U0.grp_writeTiles_Pipeline_i_BLOCK_loop_j_BLOCK_loop_j_output_loop_fu_78.AB_stream_blk_n) | (~AESL_inst_MM.writeTiles_U0.N_blk_n) | (~AESL_inst_MM.writeTiles_U0.P_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~AESL_inst_MM.writeTiles_U0.ABC_blk_n);
    assign proc_4_data_PIPO_blk[1] = 1'b0;
    assign proc_4_start_FIFO_blk[1] = 1'b0 | (~AESL_inst_MM.start_for_writeTiles_U0_U.if_empty_n & AESL_inst_MM.writeTiles_U0.ap_idle & ~AESL_inst_MM.start_for_writeTiles_U0_U.if_write);
