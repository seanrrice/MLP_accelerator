...
`ifndef MM_ENV__SV                                                                                   
    ...
    function void MM_env::build_phase(uvm_phase phase);                                                    
        ...
        MM_cfg.gmem_cfg.set_default();
        MM_cfg.gmem_cfg.drv_type = axi_pkg::SLAVE;
        MM_cfg.gmem_cfg.reset_level = axi_pkg::RESET_LEVEL_LOW;
    ...
    function void MM_env::connect_phase(uvm_phase phase);
        ...
        if(MM_cfg.gmem_cfg.drv_type==axi_pkg::MASTER ||MM_cfg.gmem_cfg.drv_type==axi_pkg::SLAVE)
            MM_virtual_sqr.gmem_sqr = axi_master_gmem.vsqr;
